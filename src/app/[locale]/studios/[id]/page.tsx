  ...
  return (
    <AuthenticatedLayout>
      ...
      <div>
        ...
        {averageRatings && studio.evaluation_count > 0 && (
          <div className="flex items-center gap-2">
            <div className="flex">{renderStars(averageRatings.overall)}</div>
      ...
      <Alert className="mb-4">
        ...
        <AlertDescription>{t('editNotice.detailDescription')}</AlertDescription>
      </Alert>
                  ...
                  {evaluations.slice(0, 5).map(evaluation => (
                    <div key={evaluation.id} className="border rounded-lg p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge variant="outline">{evaluation.user_role}</Badge>
                      </div>
                      {evaluation.comment && (
