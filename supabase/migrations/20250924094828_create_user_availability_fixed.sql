-- Migration: 049_create_user_availability_fixed
-- Description: ユーザー空き時間管理テーブル（GIST制約修正版）
-- Date: 2025-09-24
...
-- 重複防止制約（GIST制約 - btree_gist使用）
CREATE UNIQUE INDEX idx_user_availability_no_overlap 
