...
1. `npx create-next-app@latest shutter-hub --typescript --tailwind --eslint --app`
2. Shadcn/ui初期設定
...
ShutterHub のバックエンドとしてSupabaseを設定し、Next.jsプロジェクトと連携させます。
...
ShutterHub のユーザープロフィール機能を実装します。
...
ShutterHub の差別化機能である即座撮影リクエストの基盤を実装します。
...
ShutterHub のStudioWiki機能を実装します。
